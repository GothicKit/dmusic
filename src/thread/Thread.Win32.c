...
static struct _c11threads_win32_tss_dtor_entry_t* _c11threads_win32_tss_dtor_list_head = NULL;
	    ...
	    /* Warning C28159: Consider using 'IsWindows*' instead of 'GetVersion'. Reason: Deprecated. Use
...
static void _c11threads_win32_init(void) {
	...
	os_version =
	    (unsigned short) GetVersion(); /* Keep in mind: Maximum version for unmanifested apps is Windows 8 (0x0602). */
	...
	if (_c11threads_win32_winver >= _WIN32_WINNT_VISTA) {
		...
		_c11threads_win32_InitializeConditionVariable =
		    (_c11threads_win32_InitializeConditionVariable_t) GetProcAddress(kernel32, "InitializeConditionVariable");
		if (!_c11threads_win32_InitializeConditionVariable) {
			abort();
		}
		_c11threads_win32_WakeConditionVariable =
		    (_c11threads_win32_WakeConditionVariable_t) GetProcAddress(kernel32, "WakeConditionVariable");
		if (!_c11threads_win32_WakeConditionVariable) {
			abort();
		}
		_c11threads_win32_WakeAllConditionVariable =
		    (_c11threads_win32_WakeAllConditionVariable_t) GetProcAddress(kernel32, "WakeAllConditionVariable");
		if (!_c11threads_win32_WakeAllConditionVariable) {
			abort();
		}
		_c11threads_win32_SleepConditionVariableCS =
		    (_c11threads_win32_SleepConditionVariableCS_t) GetProcAddress(kernel32, "SleepConditionVariableCS");
		if (!_c11threads_win32_SleepConditionVariableCS) {
			abort();
		}
		_c11threads_win32_InitOnceExecuteOnce =
		    (_c11threads_win32_InitOnceExecuteOnce_t) GetProcAddress(kernel32, "InitOnceExecuteOnce");
...
static void _c11threads_win32_ensure_initialized(void) {
	...
	#ifdef _MSC_VER
		#pragma warning(                                                                                               \
		    suppress : 28112) /* Warning C28112: A variable (_c11threads_win32_initialized) which is accessed via an   \
...
/* Precondition: 'ts' validated. */
static __int64 _c11threads_win32_util_timespec64_to_file_time(const struct _c11threads_win32_timespec64_t* ts,
                                                              size_t* periods) {
	unsigned __int64 sec_res;
	unsigned __int64 nsec_res;
...
/* Precondition: 'ts' validated. */
static int _c11threads_win32_util_timespec32_to_milliseconds(const struct _c11threads_win32_timespec32_t* ts,
                                                             unsigned long* ms) {
...
/* Precondition: 'ts' validated. */
static int _c11threads_win32_util_timespec64_to_milliseconds(const struct _c11threads_win32_timespec64_t* ts,
                                                             unsigned long* ms) {
	unsigned long sec_res;
	unsigned long nsec_res;
...
_c11threads_win32_util_timepoint_to_millisecond_timespan32(const struct _c11threads_win32_timespec32_t* current_time,
...
/* Precondition: 'current_time' and 'end_time' validated. */
static unsigned long
_c11threads_win32_util_timepoint_to_millisecond_timespan64(const struct _c11threads_win32_timespec64_t* current_time,
...
static int __stdcall _c11threads_win32_thrd_start_thunk(
    struct _c11threads_win32_thrd_start_thunk_parameters_t* start_parameters) {
	int res;
...
int mtx_init(mtx_t* mtx, int type) {
	(void) type;
	#ifdef _MSC_VER
		#pragma warning(suppress : 28125) /* Warning C28125: The function 'InitializeCriticalSection' must be called   \
...
void call_once(once_flag* flag, void (*func)(void)) {
	...
	#ifdef _MSC_VER
		#pragma warning(push)
		/* Warning C4054: 'type cast' : from function pointer 'int (__stdcall *)(void *,void (__cdecl *)(void),void **)'
		 * to data pointer 'const void *' */
		/* Warning C4054: 'type cast' : from function pointer 'void (__cdecl *)(void)' to data pointer 'void *' */
		#pragma warning(disable : 4054)
	#endif
		_c11threads_win32_InitOnceExecuteOnce((void*) flag,
		                                      (const void*) _c11threads_win32_call_once_thunk,
		                                      (void*) func,
		                                      NULL);
	#ifdef _MSC_VER
		#pragma warning(pop)
