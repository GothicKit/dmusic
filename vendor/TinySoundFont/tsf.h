...
TSFDEF int tsf_load_presets(tsf* res, struct tsf_hydra *hydra, unsigned int fontSampleCount);
...
int tsf_load_presets(tsf* res, struct tsf_hydra *hydra, unsigned int fontSampleCount)
{
